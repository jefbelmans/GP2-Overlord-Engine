...
public:
	...
	void SaveTextureToFile(const SceneContext& sceneContext, const std::wstring& fileName) const;
	void LoadTextureFromFile(const D3D11Context& d3dContext, const std::wstring& fileName);
